...
#SBATCH -J "exp_2_a100_gp_seed_63_epochs_10"

#SBATCH -A p_da_studenten
#SBATCH --mail-user=julien.fischer@mailbox.tu-dresden.de
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH -o /beegfs/global0/ws/s8732099-diploma_thesis/slurm_output/exp_2/a100_gp_seed_63_epochs_10_normal.out
#SBATCH -e /beegfs/global0/ws/s8732099-diploma_thesis/slurm_output/exp_2/a100_gp_seed_63_epochs_10_error.out
...
python /beegfs/global0/ws/s8732099-diploma_thesis/git/diploma_thesis/cnn/experiments_da.py \
    ...
    run_eval_phase.epochs=10 \
    run_eval_phase.scheduler_epochs=10 \
    run_search_phase.epochs=5 \
