...
#SBATCH -J "exp_2_extended_a100_gp_seed_63_epochs_300"

#SBATCH -A p_da_studenten
#SBATCH --mail-user=julien.fischer@mailbox.tu-dresden.de
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH -o /beegfs/global0/ws/s8732099-diploma_thesis/slurm_output/exp_2_extended/a100_gp_seed_63_epochs_300_normal.out
#SBATCH -e /beegfs/global0/ws/s8732099-diploma_thesis/slurm_output/exp_2_extended/a100_gp_seed_63_epochs_300_error.out
...
python /beegfs/global0/ws/s8732099-diploma_thesis/git/diploma_thesis/cnn/experiments_da.py \
    ...
    method.standardize_valid_errors=false \
    ...
    run_eval_phase.epochs=300 \
    run_eval_phase.scheduler_epochs=300 \
    hydra.run.dir=/beegfs/global0/ws/s8732099-diploma_thesis/experiments_da/exp_2_extended/a100/\${method.name}-seed_\${method.gp_seed}-epochs_\${run_eval_phase.epochs}
