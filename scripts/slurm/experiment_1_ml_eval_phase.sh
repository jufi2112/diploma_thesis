...
#SBATCH -e /scratch/ws/1/s8732099-da/slurm_output/exp_1/v100_grid_search_evaluate_only_seed_2554_error.out
...
python /scratch/ws/1/s8732099-da/git/gaea_release/cnn/experiments_da.py \
    ...
    hydra.run.dir=/scratch/ws/1/s8732099-da/experiments_da/exp_1/v100/\${method.name}-batch_size_256
