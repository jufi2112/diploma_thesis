...
#SBATCH -o /scratch/ws/1/s8732099-da/slurm_output/exp_1/v100_grid_search_search_only_seed_2554_normal.out
#SBATCH -e /scratch/ws/1/s8732099-da/slurm_output/exp_1/v100_grid_search_search_only_seed_2554_error.out
